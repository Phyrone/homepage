...
<div class="flex flex-none flex-wrap">
  <div class="flex-auto">
    Rotate:
    <kbd class="kbd" class:bg-primary={rotate} class:bg-primary-content={rotate}>Space</kbd>
  </div>
  <div class="flex-auto">
    Enable Orbit Control:
    <kbd class="kbd" class:bg-primary={controll} class:bg-primary-content={controll}>C</kbd>
  </div>
  <div class="flex-auto">
    Reset Rotation:
    <kbd
      ...
      class:bg-primary-content={pressed_keys.includes('KeyR')}>R</kbd
    >
  </div>
</div>
...
<div class="flex-auto">
  {#key controll}
    <Canvas autoRender={true}>
      <TestScene bind:rotate={rotate} bind:controll={controll} bind:rotation={rotation} />
    </Canvas>
  {/key}
</div>
